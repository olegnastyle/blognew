<template>
    <nav class="bg-white border-gray-200 dark:bg-gray-900">
        <div class="flex flex-wrap items-center justify-between mx-auto py-4">
            <a href="http://825f3fb1e2d0.vps.myjino.ru/" class="flex items-center space-x-3 rtl:space-x-reverse">
                <img src="http://825f3fb1e2d0.vps.myjino.ru/uploads/balanced_diet_686b9878eb.ico" class="h-8" alt="Flowbite Logo" />

    ...
    <div class="mx-auto w-full py-6 lg:py-8">
        <div class="md:flex md:justify-between">
          <div class="mb-6 md:mb-0">
              <a href="http://panel.825f3fb1e2d0.vps.myjino.ru/" class="flex items-center">
                  <img src="http://panel.825f3fb1e2d0.vps.myjino.ru/uploads/balanced_diet_686b9878eb.ico" class="h-8 me-3" alt="FlowBite Logo" />
